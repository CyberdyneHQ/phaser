...
var spine = (() => {
    ...
    var TextureFilter = /* @__PURE__ */ ((TextureFilter3) => {
        ...
        TextureFilter3[(TextureFilter3["MipMapNearestNearest"] = 9984)] =
            "MipMapNearestNearest";
        TextureFilter3[(TextureFilter3["MipMapLinearNearest"] = 9985)] =
            "MipMapLinearNearest";
        TextureFilter3[(TextureFilter3["MipMapNearestLinear"] = 9986)] =
            "MipMapNearestLinear";
        TextureFilter3[(TextureFilter3["MipMapLinearLinear"] = 9987)] =
            "MipMapLinearLinear";
        ...
        updateWorldTransformWith(
            ...
            switch (this.data.transformMode) {
                ...
                case 4 /* NoScaleOrReflection */: {
                    ...
                    if (
                        this.data.transformMode == 3 /* NoScale */ &&
                        pa * pd - pb * pc < 0 !=
    ...
    var _SkeletonRenderer = class {
        ...
        computeMeshVertices(slot, mesh, pma) {
            ...
            if (vertices.length < mesh.worldVerticesLength)
                this.vertices = vertices = Utils.newFloatArray(
